...
static struct twl_mapping twl6030_map[] = {
	 ...
	 * so they continue to match the order in this table.
	 */
	{ SUB_CHIP_ID1, TWL6030_BASEADD_USB },		/* 00 TWL_MODULE_USB */
	{ SUB_CHIP_ID3, TWL6030_BASEADD_AUDIO },	/* 01 TWL_MODULE_AUDIO_VOICE */
	{ SUB_CHIP_ID2, TWL6030_BASEADD_DIEID },	/* 02 ? */
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID1, TWL6030_BASEADD_PIH },		/* 04 TWL_MODULE_PIH */

	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID1, TWL6030_BASEADD_GPADC_CTRL },	/* 07 TWL_MODULE_MADC */
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },

	{ SUB_CHIP_ID1, TWL6030_BASEADD_CHARGER },	/* 0a TWL_MODULE_MAIN_CHARGE */
	{ SUB_CHIP_ID1, TWL6030_BASEADD_GASGAUGE },	/* 0b TWL6030_MODULE_GASGAUGE */
	{ SUB_CHIP_ID1, TWL6030_BASEADD_PWM },		/* 0c TWL_MODULE_PWM */
	{ SUB_CHIP_ID0, TWL6030_BASEADD_ZERO },		/* 0d TWL6030_MODULE_ID0 */
	{ SUB_CHIP_ID1, TWL6030_BASEADD_ZERO },		/* 0e TWL6030_MODULE_ID1 */

	{ SUB_CHIP_ID2, TWL6030_BASEADD_ZERO },		/* 0f TWL6030_MODULE_ID2 */
	{ SUB_CHIP_ID2, TWL6030_BASEADD_ZERO },		/* 10 ? */
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID2, TWL6030_BASEADD_RSV },
	{ SUB_CHIP_ID0, TWL6030_BASEADD_PM_MASTER },	/* 14 TWL_MODULE_PM_MASTER */
	{ SUB_CHIP_ID0, TWL6030_BASEADD_PM_SLAVE_MISC }, /* 15 TWL_MODULE_PM_RECEIVER */

	{ SUB_CHIP_ID0, TWL6030_BASEADD_RTC },		/* 16 TWL_MODULE_RTC */
	{ SUB_CHIP_ID0, TWL6030_BASEADD_MEM },		/* 17 ? */
};
...
static int
add_children(struct twl4030_platform_data *pdata, const struct i2c_device_id *id)
{
	...
	if (twl_has_bci() && pdata->bci && twl_class_is_4030() && 
	...
	/* First add the regulators so that they can be used by transceiver */
		...
		if (!strcmp(id->name, "tps65921")) {
			/* accessory interrupt */
			irq_offset = ACCESSORY_INTR_OFFSET;
		} else {
			/* usb interrupt */
			irq_offset = USB_INTR_OFFSET;
		}
		
		child = add_child(0, usb_drv_name,
				pdata->usb, sizeof(*pdata->usb),
				true,
				/* irq0 = USB_PRES, irq1 = (see above) */
				pdata->irq_base + USB_PRES_INTR_OFFSET,
				pdata->irq_base + irq_offset);
...
static void _init_twl6030_settings(void)
{
	...
	if (!(machine_has_tps62361() || cpu_is_omap446x()))
