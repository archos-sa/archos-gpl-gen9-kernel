...
/*
 * HACK: Define this to disable DPLL_PER cascading (some Gen9 boards become
 * unstable when DPLL_PER cascading is enabled).
 */
#define DISABLE_DPLL_PER_CASCADING
...
int dpll_cascading_blocker_hold(struct device *dev)
{
	...
	down_write(&dpll_cascading_lock);
...
#ifndef DISABLE_DPLL_PER_CASCADING
