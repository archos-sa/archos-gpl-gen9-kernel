...
/*
 * Signals different on CYN package compared to superset
 */
#if defined(CONFIG_OMAP_MUX) && defined(CONFIG_OMAP_PACKAGE_CYN)
static struct omap_mux __initdata omap36xx_cyn_subset[] = {
	_OMAP3_MUXENTRY(CAM_D7, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_D8, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_D9, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_D9, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_FLD, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_PCLK, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_STROBE, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_VS, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(CAM_WEN, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(DSS_DATA22, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(DSS_DATA23, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART3_CTS_RCTX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART3_RTS_SD, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART3_TX_IRTX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART3_RX_IRRX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_NCS3, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_NCS4, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_NCS5, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_NCS6, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART2_CTS, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART2_RTS, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART2_RX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(UART2_TX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCBSP4_CLKX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCBSP4_DR, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCBSP4_DX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCBSP4_FSX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCBSP1_CLKX, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(I2C3_SCL, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(I2C3_SDA, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(GPMC_WAIT3, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(HDQ_SIO, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCBSP_CLKS, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCSPI1_CLK, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCSPI1_CS0, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCSPI1_SIMO, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(MCSPI1_SOMI, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SDMMC1_DAT4, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SDMMC1_DAT5, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SDMMC1_DAT6, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SDMMC1_DAT7, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SYS_BOOT4, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SYS_BOOT6, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	_OMAP3_MUXENTRY(SYS_CLKOUT1, 0,
		NULL, NULL, NULL, NULL,
		NULL, NULL, NULL, NULL),
	{ .reg_offset = OMAP_MUX_TERMINATOR },
};
#else
#define omap36xx_cyn_subset	NULL
#endif
/*
 * Balls for CYN package
 * 385-pin s-PBGA Package, 0.50mm Ball Pitch (Bottom)
 *
  */
#if defined(CONFIG_OMAP_MUX) && defined(CONFIG_DEBUG_FS)	\
		&& defined(CONFIG_OMAP_PACKAGE_CYN)
static struct omap_ball __initdata omap36xx_cyn_ball[] = {
	_OMAP3_BALLENTRY(CAM_D0, "y15", NULL),
	_OMAP3_BALLENTRY(CAM_D1, "w15", NULL),
	_OMAP3_BALLENTRY(CAM_D10, "h22", NULL),
	_OMAP3_BALLENTRY(CAM_D11, "h21", NULL),
	_OMAP3_BALLENTRY(CAM_D2, "f19", NULL),
	_OMAP3_BALLENTRY(CAM_D3, "g21", NULL),
	_OMAP3_BALLENTRY(CAM_D4, "g20", NULL),
	_OMAP3_BALLENTRY(CAM_D5, "g19", NULL),
	_OMAP3_BALLENTRY(CAM_XCLKA, "h20", NULL),
	_OMAP3_BALLENTRY(CAM_XCLKB, "j22", NULL),
	_OMAP3_BALLENTRY(DSS_ACBIAS, "k21", NULL),
	_OMAP3_BALLENTRY(DSS_DATA0, "aa17", NULL),
	_OMAP3_BALLENTRY(DSS_DATA1, "ab17", NULL),
	_OMAP3_BALLENTRY(DSS_DATA10, "y14", NULL),
	_OMAP3_BALLENTRY(DSS_DATA11, "aa14", NULL),
	_OMAP3_BALLENTRY(DSS_DATA12, "ab14", NULL),
	_OMAP3_BALLENTRY(DSS_DATA13, "aa15", NULL),
	_OMAP3_BALLENTRY(DSS_DATA14, "ab16", NULL),
	_OMAP3_BALLENTRY(DSS_DATA15, "aa16", NULL),
	_OMAP3_BALLENTRY(DSS_DATA16, "u22", NULL),
	_OMAP3_BALLENTRY(DSS_DATA17, "v22", NULL),
	_OMAP3_BALLENTRY(DSS_DATA18, "l21", NULL),
	_OMAP3_BALLENTRY(DSS_DATA19, "l20", NULL),
	_OMAP3_BALLENTRY(DSS_DATA2, "aa18", NULL),
	_OMAP3_BALLENTRY(DSS_DATA20, "k22", NULL),
	_OMAP3_BALLENTRY(DSS_DATA21, "l19", NULL),
	_OMAP3_BALLENTRY(DSS_DATA3, "ab18", NULL),
	_OMAP3_BALLENTRY(DSS_DATA4, "aa19", NULL),
	_OMAP3_BALLENTRY(DSS_DATA5, "ab19", NULL),
	_OMAP3_BALLENTRY(DSS_DATA6, "k20", NULL),
	_OMAP3_BALLENTRY(DSS_DATA7, "k19", NULL),
	_OMAP3_BALLENTRY(DSS_DATA8, "p22", NULL),
	_OMAP3_BALLENTRY(DSS_DATA9, "r22", NULL),
	_OMAP3_BALLENTRY(DSS_HSYNC, "j21", NULL),
	_OMAP3_BALLENTRY(DSS_PCLK, "j19", NULL),
	_OMAP3_BALLENTRY(DSS_VSYNC, "j20", NULL),
	_OMAP3_BALLENTRY(ETK_CLK, "ab3", NULL),
	_OMAP3_BALLENTRY(ETK_CTL, "r4", NULL),
	_OMAP3_BALLENTRY(ETK_D0, "w4", NULL),
	_OMAP3_BALLENTRY(ETK_D1, "y4", NULL),
	_OMAP3_BALLENTRY(ETK_D10, "p4", NULL),
	_OMAP3_BALLENTRY(ETK_D11, "aa5", NULL),
	_OMAP3_BALLENTRY(ETK_D12, "ab5", NULL),
	_OMAP3_BALLENTRY(ETK_D13, "w6", NULL),
	_OMAP3_BALLENTRY(ETK_D14, "y6", NULL),
	_OMAP3_BALLENTRY(ETK_D15, "aa6", NULL),
	_OMAP3_BALLENTRY(ETK_D2, "aa4", NULL),
	_OMAP3_BALLENTRY(ETK_D3, "ab4", NULL),
	_OMAP3_BALLENTRY(ETK_D4, "v4", NULL),
	_OMAP3_BALLENTRY(ETK_D5, "aa3", NULL),
	_OMAP3_BALLENTRY(ETK_D6, "w5", NULL),
	_OMAP3_BALLENTRY(ETK_D7, "y5", NULL),
	_OMAP3_BALLENTRY(ETK_D8, "t4", NULL),
	_OMAP3_BALLENTRY(ETK_D9, "u4", NULL),
	_OMAP3_BALLENTRY(GPMC_A1, "h1", NULL),
	_OMAP3_BALLENTRY(GPMC_A10, "f4", NULL),
	_OMAP3_BALLENTRY(GPMC_A2, "g1", NULL),
	_OMAP3_BALLENTRY(GPMC_A3, "g2", NULL),
	_OMAP3_BALLENTRY(GPMC_A4, "g3", NULL),
	_OMAP3_BALLENTRY(GPMC_A5, "f2", NULL),
	_OMAP3_BALLENTRY(GPMC_A6, "f3", NULL),
	_OMAP3_BALLENTRY(GPMC_A7, "e2", NULL),
	_OMAP3_BALLENTRY(GPMC_A8, "e3", NULL),
	_OMAP3_BALLENTRY(GPMC_A9, "e4", NULL),
	_OMAP3_BALLENTRY(GPMC_CLK, "w1", NULL),
	_OMAP3_BALLENTRY(GPMC_D10, "r1", NULL),
	_OMAP3_BALLENTRY(GPMC_D11, "t1", NULL),
	_OMAP3_BALLENTRY(GPMC_D12, "u1", NULL),
	_OMAP3_BALLENTRY(GPMC_D13, "v1", NULL),
	_OMAP3_BALLENTRY(GPMC_D14, "k2", NULL),
	_OMAP3_BALLENTRY(GPMC_D15, "l2", NULL),
	_OMAP3_BALLENTRY(GPMC_D8, "j3", NULL),
	_OMAP3_BALLENTRY(GPMC_D9, "j4", NULL),
	_OMAP3_BALLENTRY(GPMC_NBE0_CLE, "h2", NULL),
	_OMAP3_BALLENTRY(GPMC_NBE1, "j1", NULL),
	_OMAP3_BALLENTRY(GPMC_NCS7, "d4", NULL),
	_OMAP3_BALLENTRY(GPMC_NWP, "c2", NULL),
	_OMAP3_BALLENTRY(HSUSB0_CLK, "w21", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA0, "t20", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA1, "y21", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA2, "n19", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA3, "w20", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA4, "p19", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA5, "u20", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA6, "v20", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DATA7, "aa21", NULL),
	_OMAP3_BALLENTRY(HSUSB0_DIR, "p20", NULL),
	_OMAP3_BALLENTRY(HSUSB0_NXT, "v21", NULL),
	_OMAP3_BALLENTRY(HSUSB0_STP, "r20", NULL),
	_OMAP3_BALLENTRY(I2C2_SCL, "ab7", NULL),
	_OMAP3_BALLENTRY(I2C2_SDA, "ab6", NULL),
	_OMAP3_BALLENTRY(I2C4_SCL, "aa12", NULL),
	_OMAP3_BALLENTRY(I2C4_SDA, "y12", NULL),
	_OMAP3_BALLENTRY(JTAG_EMU0, "y9", NULL),
	_OMAP3_BALLENTRY(JTAG_EMU1, "w9", NULL),
	_OMAP3_BALLENTRY(MCBSP1_CLKR, "u21", NULL),
	_OMAP3_BALLENTRY(MCBSP1_DR, "y22", NULL),
	_OMAP3_BALLENTRY(MCBSP1_DX, "m20", NULL),
	_OMAP3_BALLENTRY(MCBSP1_FSR, "n20", NULL),
	_OMAP3_BALLENTRY(MCBSP1_FSX, "w22", NULL),
	_OMAP3_BALLENTRY(MCBSP2_CLKX, "n21", NULL),
	_OMAP3_BALLENTRY(MCBSP2_DR, "r21", NULL),
	_OMAP3_BALLENTRY(MCBSP2_DX, "m21", NULL),
	_OMAP3_BALLENTRY(MCBSP2_FSX, "p21", NULL),
	_OMAP3_BALLENTRY(MCBSP3_CLKX, "p3", NULL),
	_OMAP3_BALLENTRY(MCBSP3_DR, "t3", NULL),
	_OMAP3_BALLENTRY(MCBSP3_DX, "u3", NULL),
	_OMAP3_BALLENTRY(MCBSP3_FSX, "r3", NULL),
	_OMAP3_BALLENTRY(MCSPI1_CS3, "l4", NULL),
	_OMAP3_BALLENTRY(MCSPI2_CLK, "n3", NULL),
	_OMAP3_BALLENTRY(MCSPI2_CS0, "k4", NULL),
	_OMAP3_BALLENTRY(MCSPI2_CS1, "k3", NULL),
	_OMAP3_BALLENTRY(MCSPI2_SIMO, "m4", NULL),
	_OMAP3_BALLENTRY(MCSPI2_SOMI, "n4", NULL),
	_OMAP3_BALLENTRY(SDMMC1_CLK, "t19", NULL),
	_OMAP3_BALLENTRY(SDMMC1_CMD, "y20", NULL),
	_OMAP3_BALLENTRY(SDMMC1_DAT0, "aa20", NULL),
	_OMAP3_BALLENTRY(SDMMC1_DAT1, "w19", NULL),
	_OMAP3_BALLENTRY(SDMMC1_DAT2, "v19", NULL),
	_OMAP3_BALLENTRY(SDMMC1_DAT3, "u19", NULL),
	_OMAP3_BALLENTRY(SDMMC2_CLK, "m2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_CMD, "y2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT0, "y1", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT1, "w2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT2, "v2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT3, "u2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT4, "t2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT5, "r2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT6, "p2", NULL),
	_OMAP3_BALLENTRY(SDMMC2_DAT7, "n2", NULL),
	_OMAP3_BALLENTRY(SYS_BOOT0, "y7", NULL),
	_OMAP3_BALLENTRY(SYS_BOOT1, "w7", NULL),
	_OMAP3_BALLENTRY(SYS_BOOT2, "aa8", NULL),
	_OMAP3_BALLENTRY(SYS_BOOT3, "y8", NULL),
	_OMAP3_BALLENTRY(SYS_BOOT5, "w8", NULL),
	_OMAP3_BALLENTRY(SYS_CLKOUT2, "w13", NULL),
	_OMAP3_BALLENTRY(SYS_CLKREQ, "w11", NULL),
	_OMAP3_BALLENTRY(SYS_NIRQ, "ab12", NULL),
	_OMAP3_BALLENTRY(SYS_NRESWARM, "aa13", NULL),
	_OMAP3_BALLENTRY(SYS_OFF_MODE, "y13", NULL),
	_OMAP3_BALLENTRY(UART1_CTS, "aa2", NULL),
	_OMAP3_BALLENTRY(UART1_RTS, "v3", NULL),
	_OMAP3_BALLENTRY(UART1_RX, "y3", NULL),
	_OMAP3_BALLENTRY(UART1_TX, "w3", NULL),
	{ .reg_offset = OMAP_MUX_TERMINATOR },
};
#else
#define omap36xx_cyn_ball	 NULL
#endif
...
int __init omap3_mux_init(struct omap_board_mux *board_subset, int flags)
{
	...
	case OMAP_PACKAGE_CBP:
		...
		break;
	case OMAP_PACKAGE_CYN:
		package_subset = omap36xx_cyn_subset;
		package_balls = omap36xx_cyn_ball;
		break;
	default:
