...
static struct omap_hwmod omap3xxx_usbhs_ehci_hwmod;
static struct omap_hwmod omap3xxx_usbhs_ohci_hwmod;
...
/* L3 <- USB HOST HS interface */
static struct omap_hwmod_ocp_if omap3xxx_usb_host_hs__l3 = {
...
static struct omap_hwmod_ocp_if *omap3xxx_usb_host_hs_masters[] = {
	&omap3xxx_usb_host_hs__l3,
};

/* includes UHH and TLL base */
static struct omap_hwmod_addr_space omap3xxx_usb_host_hs_addrs[] = {
	{
		.pa_start	= OMAP34XX_UHH_CONFIG_BASE,
		.pa_end		= OMAP34XX_UHH_CONFIG_BASE + SZ_1K - 1,
		.flags		= ADDR_TYPE_RT
	},
};
...
static struct omap_hwmod_ocp_if omap3xxx_l4_core__usb_host_hs = {
	...
	.addr_cnt	= ARRAY_SIZE(omap3xxx_usb_host_hs_addrs),
	.user		= OCP_USER_MPU | OCP_USER_SDMA,
};
...
static struct omap_hwmod_opt_clk usb_host_hs_opt_clks[] = {
	{ .role = "fclk1", .clk = "usbhost_48m_fck" },
	{ .role = "fclk2", .clk = "usbhost_120m_fck" },
};
...
static struct omap_hwmod_ocp_if omap3xxx_l4_core__usb_tll_hs = {
	...
	.addr_cnt	= ARRAY_SIZE(omap3xxx_usb_tll_hs_addrs),
	.user		= OCP_USER_MPU,
};
...
static struct omap_hwmod omap3xxx_usb_tll_hs_hwmod = {
	...
	.mpu_irqs_cnt	= ARRAY_SIZE(omap3xxx_usb_tll_hs_irqs),
	.main_clk	= "usbtll_ick",
	.prcm = {
		.omap2  = {
			.module_offs	= CORE_MOD,
 ...
 * EHCI controller
 */
static struct omap_hwmod_class omap3xxx_usbhs_ehci_hwmod_class = {
	.name = "usb_ehci",
};

/* usb_host_hs */
static struct omap_hwmod_irq_info omap3xxx_usbhs_ehci_irqs[] = {
	{ .name = "ehci", .irq = 77 },
};

/* usb_host_hs master ports */
static struct omap_hwmod_ocp_if *omap3xxx_usbhs_ehci_masters[] = {
	&omap3xxx_usb_host_hs__l3,
};

/* includes UHH and TLL base */
static struct omap_hwmod_addr_space omap3xxx_usbhs_ehci_addrs[] = {
	{
		.pa_start	= OMAP34XX_EHCI_BASE,
		.pa_end		= OMAP34XX_EHCI_BASE + SZ_1K -1,
		.flags		= ADDR_MAP_ON_INIT
	},
};

/* l4_core -> usb_host_hs */
static struct omap_hwmod_ocp_if omap3xxx_l4_core__usbhs_ehci = {
	.master		= &omap3xxx_l4_core_hwmod,
	.slave		= &omap3xxx_usbhs_ehci_hwmod,
	.clk		= "core_l4_ick",
	.addr		= omap3xxx_usbhs_ehci_addrs,
	.addr_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ehci_addrs),
	.user		= OCP_USER_SDMA,
};

/* usb_host_hs slave ports */
static struct omap_hwmod_ocp_if *omap3xxx_usbhs_ehci_slaves[] = {
	&omap3xxx_l4_core__usbhs_ehci,
};

static struct omap_hwmod omap3xxx_usbhs_ehci_hwmod = {
	.name		= "usbhs_ehci",
	.class		= &omap3xxx_usbhs_ehci_hwmod_class,
	.mpu_irqs	= omap3xxx_usbhs_ehci_irqs,
	.mpu_irqs_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ehci_irqs),
	.main_clk	= NULL,
	/* FIXME .prcm = {
		.omap4 = {
			.clkctrl_reg = NULL,
	...
	.slaves		= omap3xxx_usbhs_ehci_slaves,
	.slaves_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ehci_slaves),
	.masters	= omap3xxx_usbhs_ehci_masters,
	.masters_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ehci_masters),
	.omap_chip	= OMAP_CHIP_INIT(CHIP_GE_OMAP3430ES2),
};
...
static struct omap_hwmod_class omap3xxx_usbhs_ohci_hwmod_class = {
	.name = "usb_ohci",
};

/* usb_host_hs */
static struct omap_hwmod_irq_info omap3xxx_usbhs_ohci_irqs[] = {
	{ .name = "ohci", .irq = 76 },
};

/* usb_host_hs master ports */
static struct omap_hwmod_ocp_if *omap3xxx_usbhs_ohci_masters[] = {
	&omap3xxx_usb_host_hs__l3,
};

/* includes UHH and TLL base */
static struct omap_hwmod_addr_space omap3xxx_usbhs_ohci_addrs[] = {
	{
		.pa_start	= OMAP34XX_OHCI_BASE,
		.pa_end		= OMAP34XX_OHCI_BASE + SZ_1K - 1,
		.flags		= ADDR_MAP_ON_INIT
	},
};

/* l4_core -> usb_host_hs */
static struct omap_hwmod_ocp_if omap3xxx_l4_core__usbhs_ohci = {
	.master		= &omap3xxx_l4_core_hwmod,
	.slave		= &omap3xxx_usbhs_ohci_hwmod,
	.clk		= "core_l4_ick",
	.addr		= omap3xxx_usbhs_ohci_addrs,
	.addr_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ohci_addrs),
	.user		= OCP_USER_SDMA,
};

/* usb_host_hs slave ports */
static struct omap_hwmod_ocp_if *omap3xxx_usbhs_ohci_slaves[] = {
	&omap3xxx_l4_core__usbhs_ohci,
};

static struct omap_hwmod omap3xxx_usbhs_ohci_hwmod = {
	.name		= "usbhs_ohci",
	.class		= &omap3xxx_usbhs_ohci_hwmod_class,
	.mpu_irqs	= omap3xxx_usbhs_ohci_irqs,
	.mpu_irqs_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ohci_irqs),
	.main_clk	= NULL,
	/* FIXME .prcm = {
		.omap4 = {
			.clkctrl_reg = NULL,
	...
	.slaves		= omap3xxx_usbhs_ohci_slaves,
	.slaves_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ohci_slaves),
	.masters	= omap3xxx_usbhs_ohci_masters,
	.masters_cnt	= ARRAY_SIZE(omap3xxx_usbhs_ohci_masters),
	.omap_chip	= OMAP_CHIP_INIT(CHIP_GE_OMAP3430ES2),
};
...
static __initdata struct omap_hwmod *omap3xxx_hwmods[] = {
	...
	&omap3xxx_usbhs_ehci_hwmod,
	&omap3xxx_usbhs_ohci_hwmod,
	NULL,
};
