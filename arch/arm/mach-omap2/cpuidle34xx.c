...
static struct omap3_processor_cx current_cx_state;
static struct powerdomain *mpu_pd, *core_pd;
 ...
 *	C7 . MPU OFF + Core OFF
 */
static void omap3_init_power_states(void)
{
	/* C1 . MPU WFI + Core active */
