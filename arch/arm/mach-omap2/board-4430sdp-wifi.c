...
void sdp4430_config_wlan_mux(void)
{
...
int sdp4430_omap_wifi_status_register(void (*callback)(int card_present,
...
int sdp4430_omap_wifi_status(struct device *dev, int slot)
{
