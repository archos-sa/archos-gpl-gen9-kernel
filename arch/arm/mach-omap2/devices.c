...
static struct resource omap_vout_resource[4];
#if defined(CONFIG_FB_OMAP2) || defined(CONFIG_FB_OMAP2_MODULE)
	#define OMAP4_NUM_RESOURCES (4 - CONFIG_FB_OMAP2_NUM_FBS)
	#define OMAP3_NUM_RESOURCES (3 - CONFIG_FB_OMAP2_NUM_FBS)
#else
	#define OMAP4_NUM_RESOURCES (3)
	#define OMAP3_NUM_RESOURCES (2)
#endif
...
{
	if( cpu_is_omap44xx() ) {
		omap_vout_device.num_resources = OMAP4_NUM_RESOURCES;
	} else {
		omap_vout_device.num_resources = OMAP3_NUM_RESOURCES;
	}
