...
*/
	omap_mux_init_signal("dss_data0.dsi_dx0", OMAP_PIN_INPUT);
	omap_mux_init_signal("dss_data1.dsi_dy0", OMAP_PIN_INPUT);
	omap_mux_init_signal("dss_data2.dsi_dx1", OMAP_PIN_INPUT);
	omap_mux_init_signal("dss_data3.dsi_dy1", OMAP_PIN_INPUT);
	omap_mux_init_signal("dss_data4.dsi_dx2", OMAP_PIN_INPUT);
	omap_mux_init_signal("dss_data5.dsi_dy2", OMAP_PIN_INPUT);
