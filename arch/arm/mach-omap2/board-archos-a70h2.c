...
#define GPIO_HDMI_5V    	121	/* fixme: from config tags? */
...
static void remux_regulator_gpio(int gpio)
{
	...
	case GPIO_HDMI_5V:
		omap_mux_init_signal("sdmmc1_cmd.gpio_121", OMAP_PIN_INPUT|OMAP_PIN_OUTPUT);
		break;
...
static struct regulator_consumer_supply fixed_reg_vcc_consumer[] = {
	...
	REGULATOR_SUPPLY("hsusb_opt1", "uhhtll-omap"),
};
...
static struct archos_sata_config sata_config __initdata = {
	...
	.rev[0] = {
		.sata_power = 122,
		.sata_power_mux = "sdmmc1_dat0.gpio_122",
		.sata_ready = 123,
		.hdd_power  = 120,
		.hdd_power_mux = "sdmmc1_clk.gpio_120",
	},
	.rev[1] = {
		.sata_power = 122,
		.sata_power_mux = "sdmmc1_dat0.gpio_122",
	...
	.rev[3] = {
		.sata_power = 122,
		.sata_power_mux = "sdmmc1_dat0.gpio_122",	/* manual setup. multiple pinmux possible */
		.sata_ready = 123,
		.hdd_power  = 120,
		.hdd_power_mux = "sdmmc1_clk.gpio_120",		/* manual setup. multiple pinmux possible */
	},
};
...
static struct archos_camera_config camera_config __initdata = {
	...
	.rev[0] = {
		.pwr_down = 124,
		.pwr_down_mux = "sdmmc1_dat2.gpio_124",
		.reset    = 125,
		.reset_mux = "sdmmc1_dat3.gpio_125",
	},
	.rev[1] = {
		.pwr_down = 124,
		.pwr_down_mux = "sdmmc1_dat2.gpio_124",
...
static int __init omap3_i2c_init(void)
{
	...
	omap_register_i2c_bus(3, 200, &archos_i2c_bus_pdata, board_i2c_bus3_info,
...
static int __init a70h2_opp_init(void)
{
...
device_initcall(a70h2_opp_init);
